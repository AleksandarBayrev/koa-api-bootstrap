...
export const indexRoutePutHandler: RequestMediatorHandler = async (DI: DependencyInjection, context: koa.ParameterizedContext<AppState, AppContext, IndexRoutePutResponse | ErrorResponse>, next: koa.Next) => {
