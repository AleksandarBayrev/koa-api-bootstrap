...
export const indexRouteDeleteHandler: RequestMediatorHandler = async (DI: DependencyInjection, context: koa.ParameterizedContext<AppState, AppContext, IndexRouteDeleteResponse | ErrorResponse>, next: koa.Next) => {
